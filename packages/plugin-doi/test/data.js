const ja01577a030 = {
  ...
  link: [
    {
      URL: 'https://pubs.acs.org/doi/pdf/10.1021/ja01577a030',
...
const preprint = {
  ...
  type: 'article', // <- changed by Citation.js
  created: {
    'date-parts': [[2021, 8, 18]],
    'date-time': '2021-08-18T20:25:11Z',
  ...
  author: [
    ...
    {
      ORCID: 'http://orcid.org/0000-0001-6000-6859',
      'authenticated-orcid': false,
      given: 'Stefan',
      family: 'Gravenstein',
      sequence: 'additional',
  ...
  reference: [
    {
      key: '2021082302400806000_2021.08.15.21262067v3.1',
      'doi-asserted-by': 'crossref',
      unstructured: 'Canaday DH , Carias L , Oyebanji OA , et al. Reduced BNT162b2 mRNA vaccine response in SARS-CoV-2-naive nursing home residents. Clin Infect Dis 2021.',
      DOI: '10.1101/2021.03.19.21253920'
    },
    {
      key: '2021082302400806000_2021.08.15.21262067v3.2',
      'doi-asserted-by': 'crossref',
      unstructured: 'Muller L , Andree M , Moskorz W , et al. Age-dependent immune response to the Biontech/Pfizer BNT162b2 COVID-19 vaccination. Clin Infect Dis 2021.',
      DOI: '10.1101/2021.03.03.21251066'
    },
    {
      key: '2021082302400806000_2021.08.15.21262067v3.3',
      'doi-asserted-by': 'crossref',
      unstructured: 'Nanduri S PT , Derado G. Effectiveness of Pfizer-BioNTech and Moderna Vaccines in Preventing SARS-CoV-2 Infection Among Nursing Home Residents Before and During Widespread Circulation of the SARS-CoV-2 B.1.617.2 (Delta) Variant — National Healthcare Safety Network, March 1–August 1, 2021. MMWR Morbidity and mortality weekly report 2021.',
      DOI: '10.15585/mmwr.mm7034e3'
    },
    {
      key: '2021082302400806000_2021.08.15.21262067v3.4',
      'doi-asserted-by': 'publisher',
      DOI: '10.15585/mmwr.mm7017e1'
    },
    {
      key: '2021082302400806000_2021.08.15.21262067v3.5',
      'doi-asserted-by': 'crossref',
      'first-page': '1059',
  ...
  link: [
    {
      URL: 'https://syndication.highwire.org/content/doi/10.1101/2021.08.15.21262067',
      'content-type': 'unspecified',
      'content-version': 'vor',
      'intended-application': 'similarity-checking'
    }
  ...
  deposited: {
    'date-parts': [[2021, 8, 23]],
    'date-time': '2021-08-23T09:41:43Z',
    timestamp: 1629711703000
  },
  score: 1,
  subtitle: [],
  'short-title': [],
